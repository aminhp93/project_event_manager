...
# # 			from_tower = gets.to_i
# # 			puts "Which tower do you wnat to move to?"
# # 			to_tower = gets.to_i
...
# 	def render
# 		"Towers[0]: " + @towers[0].join("  ") + "\n" +
# 		"Towers[1]: " + @towers[1].join("  ") + "\n" +
# 		"Towers[2]: " + @towers[2].join("  ") + "\n"
...
class TowersOfHanoi
	...
	def play
		...
		until won?
			...
			puts "which towers from?"
			from_tower = gets.chomp
			puts "which towers to?"
			to_tower = gets.chomp
			if valid_move?(from_tower, to_tower)
				move(from_tower, to_tower)
				display
